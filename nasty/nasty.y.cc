...
static const char *const yytname[] =
{
  ...
  "STR", "$accept", "program", "expr", "atom", 0
};
#endif
...
#line 37 "nasty.parser"
    { (yyvsp[(1) - (2)].expr_)->appendExpr((yyvsp[(2) - (2)].expr_)); (yyval.expr_) = (yyvsp[(1) - (2)].expr_); }
    break;

  case 4:

/* Line 1806 of yacc.c  */
#line 38 "nasty.parser"
    { (yyval.expr_) = new(std::nothrow) Expr(); (yyval.expr_)->appendExpr((yyvsp[(1) - (1)].expr_)); }
    break;

  case 5:

/* Line 1806 of yacc.c  */
#line 41 "nasty.parser"
    { DEBUG("match (...)"); (yyval.expr_) = (yyvsp[(2) - (3)].expr_); }
    break;

  case 6:

/* Line 1806 of yacc.c  */
#line 42 "nasty.parser"
    { DEBUG("match ID"); (yyval.expr_) = (yyvsp[(1) - (1)].expr_); }
    break;
...
#line 43 "nasty.parser"
    { DEBUG("match FLT"); (yyval.expr_) = (yyvsp[(1) - (1)].expr_); }
    break;
...
#line 44 "nasty.parser"
    { DEBUG("match INT"); (yyval.expr_) = (yyvsp[(1) - (1)].expr_); }
    break;
...
#line 45 "nasty.parser"
    { DEBUG("match STR"); (yyval.expr_) = (yyvsp[(1) - (1)].expr_); }
    break;



/* Line 1806 of yacc.c  */
#line 1493 "nasty.y.cc"
      default: break;
    }
