...
#ifndef __CC_COMMON_SERIALIZER_H__
#define __CC_COMMON_SERIALIZER_H__
...
// ------------------------------------------------------------
#define CC_COMMON_SERIALIZER_ENUM_TYPE(type)                    \
    template<>                                                            \
    class Stream<type> {                                                  \
    public:                                                              \
...
CC_COMMON_SERIALIZER_ENUM_TYPE(uint64_t);
...
CC_COMMON_SERIALIZER_ENUM_TYPE(int64_t);
...
CC_COMMON_SERIALIZER_ENUM_TYPE(uint32_t);
...
CC_COMMON_SERIALIZER_ENUM_TYPE(int32_t);
...
CC_COMMON_SERIALIZER_ENUM_TYPE(std::string);

#undef CC_COMMON_SERIALIZER_ENUM_TYPE

} // namespace serializer
} // namespace common

#endif // __CC_COMMON_SERIALIZER_H__
